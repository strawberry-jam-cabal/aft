...
def console_entry():
    ...
    parser.add_argument("file_path", metavar="FILE", help="Path to the file to fuzz")
    parser.add_argument(
        "function_name", metavar="FUNCTION_NAME", help="Name of the function to fuzz"
    )
    parser.add_argument(
        "--print-failures",
        default=False,
    ...
    parser.add_argument(
        "--all", default=False, action="store_true", help="Fuzz everything in the file"
    )
